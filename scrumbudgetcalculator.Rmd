...
```{r echo = FALSE}
hourly_cost <- 45000/12/30/7.5
cost_of_daily_standup_per_sprint <- 8 * 0.25 * 10 * hourly_cost
cost_of_planning_sprint <- 2 * 2 * 10 * hourly_cost
cost_of_sprint_review <- 10 * hourly_cost
cost_of_retrospective <- hourly_cost * 10 
cost_of_one_sprint <- cost_of_daily_standup_per_sprint + cost_of_planning_sprint + cost_of_sprint_review + cost_of_retrospective 
total_cost <- cost_of_one_sprint * 24
total_cost
```
